...
<form action="<%=path %>/manage/news" name="form" id="form" method="post">
    <div style="height:auto!important;height:550px;min-height:550px;">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="10" class="tableBasic">
            ...
            <tr>
                <th style="text-align: right;" width="200">新闻标题</th>
                <td style="text-align: left;"><input type="text" size="40" value="${e.title}" name="title"
                                                     data-rule="新闻标题:required;title;length[1~45];"
                                                     id="title"/></td>
            </tr>
            <tr>
            ...
            <tr>
                <th style="text-align: right;">新闻内容</th>
                <td style="text-align: left;">
